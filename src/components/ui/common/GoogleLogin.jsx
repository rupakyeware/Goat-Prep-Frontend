...
export default function GoogleLogin({className}) {
    return (
        <div className={`w-full py-3 px-6 border-[0.5px] border-yellow bg-transparent rounded-md flex items-center justify-center gap-3 cursor-pointer hover:bg-turqoise hover:text-black hover:border-none ${className}`}>
            <FaGoogle />
            <a
            className="w-full"
